...
export const projects = [
  {
    ...
    participation: 'Responsável pelo desenvolvimento da parte visual do jogo e pela modelagem e implementação do banco de dados.',
    experience: 'Desenvolvimento de um jogo educacional utilizando C#, GML, GameMaker e MySQL, integrando conceitos de programação, banco de dados e design em uma única solução. A participação no projeto envolveu a criação da identidade visual do jogo, elaboração das interfaces e modelagem do banco de dados responsável pelo armazenamento das informações. A experiência contribuiu para o fortalecimento da criatividade, organização e autonomia na execução de tarefas, além de aprimorar a capacidade de resolução de problemas e planejamento de projetos. O desenvolvimento do TCC também permitiu aplicar na prática os conhecimentos adquiridos ao longo do curso técnico, desde a análise de requisitos até a entrega final do produto.',
  ...
  },
  {
    ...
    problem: 'Dificuldade em monitorar tendências de mercado de maneira clara e objetiva, devido ao acesso a planilhas extensas e descentralizadas.',
    ...
    participation: 'Responsável pelo desenvolvimento do Front-End e pelo design da aplicação, criando interfaces intuitivas para visualização e análise de dados.',
    experience: 'Aplicação prática de HTML, CSS, Python, Flask e MySQL na construção de uma plataforma para monitoramento de tendências do mercado de importação e exportação. A atuação foi focada no desenvolvimento do Front-End e no design da aplicação, buscando transformar grandes volumes de dados em informações acessíveis e intuitivas para os usuários. O projeto proporcionou experiência na criação de interfaces responsivas e na colaboração com diferentes áreas da equipe, fortalecendo competências como organização, comunicação, trabalho em equipe e resolução de problemas. Além disso, contribuiu para o desenvolvimento da visão centrada no usuário e para a compreensão da importância da experiência do usuário em sistemas voltados à análise de dados.',
  ...
  },
  {
    ...
    participation: 'Atuação no desenvolvimento Front-End e Back-End da plataforma, além da função de Scrum Master, coordenando reuniões, acompanhamento de tarefas e comunicação da equipe.',
    experience: 'Atuação no desenvolvimento Front-End e Back-End de uma plataforma corporativa voltada à centralização de processos administrativos, comerciais e operacionais, utilizando React, Node.js, JavaScript, TypeScript e MySQL. Além das atividades técnicas, a experiência como Scrum Master proporcionou contato direto com metodologias ágeis, gestão de tarefas, acompanhamento de entregas e facilitação da comunicação entre os membros da equipe. O projeto contribuiu para o desenvolvimento de competências em liderança, organização, adaptabilidade e tomada de decisões, além de fortalecer habilidades relacionadas ao trabalho colaborativo e à resolução de problemas. A participação em diferentes etapas do desenvolvimento permitiu ampliar a visão sobre arquitetura de sistemas, integração entre Front-End e Back-End e construção de soluções voltadas às necessidades reais do cliente.',
  ...
  },
  {
    ...
    participation: 'Atuação como Scrum Master, auxiliando na gestão do projeto, organização das entregas e alinhamento entre equipe e cliente durante o desenvolvimento da plataforma.',
    experience: 'Vivência em um ambiente de desenvolvimento full stack utilizando React, Node.js, TypeScript, Java, Spring Boot, Docker e MySQL para a construção de uma plataforma voltada ao controle de apontamento de horas e gestão de processos administrativos. A atuação como Scrum Master proporcionou experiência prática na aplicação de metodologias ágeis, organização de sprints, acompanhamento de entregas e alinhamento entre equipe e cliente. O projeto contribui para o desenvolvimento de habilidades de liderança, comunicação interpessoal, resolução de problemas e tomada de decisões, além de fortalecer a capacidade de adaptação diante de mudanças de requisitos e desafios técnicos. A constante interação entre os membros da equipe favorece o trabalho colaborativo, o compartilhamento de conhecimento e a construção de soluções eficientes, proporcionando uma visão ampla do ciclo completo de desenvolvimento de software, desde o levantamento de requisitos até a entrega do produto.'
,
